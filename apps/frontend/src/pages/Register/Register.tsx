...
export default function Register() {
    ...
    const handleRegister = (e: FormEvent<HTMLFormElement>) => {
        ...
        // Temporary UI-only registration
        setTimeout(() => {
            setIsLoading(false)
            navigate('/')
        }, 800)
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            >
                                Join
                                <br />
                                <span className="text-[#3A7CF5]">the Challenges</span>
                            </h1>
                            ...
                            >
                                Start earning points and take on a new challenge every day.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-3">
                                ...
                                <span
                                    ...
                                    style={{ fontFamily: "'Roboto', sans-serif" }}
                                >
                                    One account is all you need for daily and weekly challenges
                                </span>
                            </div>
                        </div>
                                        ...
                                        {[
                                            ...
                                            <span
                                                ...
                                                style={{
                                                    ...
                                                    animation: `regBounce 0.8s cubic-bezier(0.33, 0, 0.66, 1) ${delay} infinite`,
                                                }}
                                            />
                                        ))}
